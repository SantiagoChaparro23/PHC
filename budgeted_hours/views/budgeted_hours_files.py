...
from budgeted_hours.forms.budgeted_hours_files_form import BudgetedHoursFilesForm
...
class BudgetedHoursFilesUpdateView(PermissionRequiredMixin, UpdateView):

    model = BudgetedHoursFiles
    form_class = BudgetedHoursFilesForm
    context_object_name = 'file'
    template_name = 'budgeted_hours_files/change.html'
    ...
    def form_valid(self, form):
        ...
        tmp_folder = f'{base}/storage/budgetedhours/{unix}'
        ...
        object = self.object
        filename = f'{base}/static/budgetedhours/{object.budgeted_hours.code}-{unix}.zip'
        ...
        files = '<br>'.join(files)
        print(files)
        obj.file = f'static/budgetedhours/{object.budgeted_hours.code}-{unix}.zip'
